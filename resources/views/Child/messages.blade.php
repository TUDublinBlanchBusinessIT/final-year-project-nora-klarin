        ...
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="h-10 w-10 rounded-full bg-gradient-to-br from-indigo-500 to-pink-500 flex items-center justify-center text-white font-extrabold shadow">
                    ...
                    {{ strtoupper(substr($child->name ?? 'C', 0, 1)) }}
                ...
                <div class="leading-tight">
                    ...
                    <div class="font-extrabold text-gray-900">
                        ...
                        Chat with {{ $child->name ?? 'Young Person' }}

                    </div>

                    <div class="text-xs text-gray-500 flex items-center gap-2">

                        <span class="opacity-80">Case: {{ $caseFile->case_reference ?? ('Case #' . $caseFile->id) }}</span>
            ...
            <a href="{{ route('socialworker.case.show', $caseFile) }}" class="text-sm font-semibold text-indigo-600 hover:text-indigo-700">
            ...
            <div class="relative overflow-hidden rounded-[28px] border border-white/60 shadow-2xl bg-white/75 backdrop-blur">
                ...
                <div class="relative flex flex-col h-[70vh]">
                        ...
                        @if($messages->isEmpty())
                            ...
                            <div class="text-center py-14">
                                ...
                                <div class="mt-1 text-sm text-gray-600">
                                    ...
                                    Send a message to {{ $child->name ?? 'the young person' }} 👋
                    ...
                    <div class="border-t bg-white/85 backdrop-blur px-4 sm:px-8 py-4">
                        ...
                        <form method="POST" action="{{ route('socialworker.messages.store', $thread) }}" class="flex items-center gap-3">
