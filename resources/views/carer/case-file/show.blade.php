                ...
                <div x-show="tab === 'caseDetails'" x-transition class="bg-white p-6 rounded-2xl shadow-sm border border-indigo-100 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="rounded-xl bg-indigo-50 p-4">
                            ...
                            <p class="font-semibold text-gray-900">{{ $case->risklevel ?? $case->risk_level ?? '-' }}</p>
                    ...
                    @if($currentPlacement)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="rounded-xl bg-pink-50 p-4">
                                ...
                                <p class="font-semibold text-gray-900">{{ $currentPlacement->type ?? '-' }}</p>
                            ...
                            <div class="rounded-xl bg-pink-50 p-4">
                                ...
                                <p class="font-semibold text-gray-900">{{ $currentPlacement->address ?? '-' }}</p>
                            ...
                            @if($currentPlacement->carer)
                                ...
                                <div class="rounded-xl bg-pink-50 p-4">
                                    ...
                                    <p class="font-semibold text-gray-900">{{ $currentPlacement->carer->name }}</p>
                            ...
                            <div class="rounded-xl bg-pink-50 p-4">
                                ...
                                <p class="font-semibold text-gray-900">
                                    ...
                                    {{ $currentPlacement->start_date ?? '-' }} - {{ $currentPlacement->end_date ?? 'Current' }}
